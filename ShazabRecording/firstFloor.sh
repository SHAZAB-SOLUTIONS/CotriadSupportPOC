...
camera_name="FirstFloor"
# echo "Recording $camera_name"
rtsp_url="rtsp://admin:Shazabadmin123@172.16.1.12:554"
...
while true; do
    ...
    ffmpeg -rtsp_transport tcp -i "$rtsp_url" -t "$duration" -vf "scale=$output_resolution" -flags +bitexact "$output_file"
done
